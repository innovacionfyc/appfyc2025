        ...
        <div class="lg:col-span-7 p-8 md:p-12 lg:p-16 flex flex-col justify-center h-full relative">
          ...
          <div class="space-y-8 relative z-20">
            <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 backdrop-blur-md shadow-lg w-fit">
              ...
              <span class="text-xs font-bold tracking-widest text-white uppercase">Sector Público</span>
            </div>

            <h2 class="text-3xl md:text-4xl lg:text-5xl font-black text-white leading-tight drop-shadow-sm">
              ¿Quieres un programa <span class="text-transparent bg-clip-text bg-gradient-to-r from-orange-200 to-white">a la medida</span> para tu entidad?
            </h2>

            <p class="text-lg text-white/90 font-medium leading-relaxed max-w-xl">
              Diseñamos experiencias de formación exclusivas: tú eliges la temática y la modalidad. 
              Nuestro equipo académico y el búho de F&C se encargan de hacer la magia.
            </p>
            ...
            <div class="flex flex-col sm:flex-row gap-4 pt-2">
              <a href="/contacto" 
                 ...
                 <span class="relative z-10">Diseñar Programa</span>

    ...
    <div class="relative" ref="dropdownContainer">
            ...
            <slot name="trigger">
                <button
                    ...
                    <span
                        ...
                        :class="internalIsOpen && showToggleIcon ? 'rotate-45' : ''">
                        {{ toggleIcon }}
                    </span>
                </button>
            </slot>
        ...
        <Transition name="dropdown-fade">
            <div v-show="internalIsOpen"
                :class="[
                    'absolute bottom-16 left-0 p-2 bg-mono-blanco/90 backdrop-blur dark:bg-mono-negro_opacity_full rounded-xl shadow-2xl border border-secundary-light dark:border-gray-700',

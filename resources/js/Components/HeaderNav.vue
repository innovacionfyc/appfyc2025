...
<template>
  ...
  >
    ...
    <div
      class="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative flex items-center justify-between"
    >
      <div class="relative z-20 flex-shrink-0">
        <Link href="/" class="group flex items-center outline-none">
          ...
          >
            <div
              class="absolute inset-[-15px] -z-10 rounded-full bg-white/90 blur-2xl transition-opacity duration-300"
      ...
      <div class="xl:hidden flex items-center z-20">
        ...
        >
          ...
          <div class="w-5 h-4 relative flex flex-col justify-between">
            <span
              class="w-full h-[2px] bg-current rounded-full transition-all duration-300 origin-left"
              :class="isMenuOpen ? 'rotate-45 translate-x-0.5 -translate-y-0.5' : ''"
            ></span>
            <span
              class="w-full h-[2px] bg-current rounded-full transition-all duration-300"

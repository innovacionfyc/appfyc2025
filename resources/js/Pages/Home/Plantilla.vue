...
<template>
  <Head :title="evento?.titulo ? evento.titulo + ' | F&C Consultores' : 'Evento'" />
  <link rel="icon" type="image/png" :href="getAreaTagImage()" />
  <meta
    name="theme-color"
    :content="evento?.area_formacion?.color_hex_principal || '#0B192C'"
  />
      ...
      >
          ...
          >
            ...
            <div class="">
              <a
                ...
                target="_blank"
                class="inline-flex items-center gap-3 px-5 py-3 bg-slate-900 text-white font-bold rounded-xl hover:scale-105 transition-all shadow-lg group"
                :style="{
              ...
              >
                ...
                >
                  <li
                    ...
                    :class="{ 'col-span-1 md:col-span-2': modulo.subtemas.length === 1 }"
                  >
                    <CheckCircle
                      class="w-4 h-4 mr-2 shrink-0 mt-0.5 transition-transform group-hover:scale-110"
                      :style="{
                        color: evento?.area_formacion?.color_hex_principal || '#10b981',
                      }"
                    />
          ...
          >
            ...
            <div class="relative z-10 flex flex-col gap-4">
              ...
              <button
                ...
                class="w-full font-black py-4 rounded-xl transition-all duration-300 hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-3 text-base text-white shadow-lg shadow-black/20"
                :style="{
                  background: evento?.area_formacion?.color_hex_principal || '#f97316',
                }"
              >
        ...
        >
          <div
            ...
            :style="{ borderColor: evento?.area_formacion?.color_hex_principal + '30' }"
          >
            <div class="relative">
              <img
                :src="
          ...
          >
            <div class="relative z-10">
              <div class="text-center border-b border-slate-50 pb-6">
                ...
                >
                  {{
                    evento.organizador.perfil_organizador.cargo || "Consultor Académico"
                  }}
                </p>
              </div>
              ...
              <div class="grid grid-cols-2 gap-3">
                ...
                <a
                  ...
                  :data-color="evento?.area_formacion?.color_hex_principal || '#f97316'"
                >
                  <Mail class="w-5 h-5 transition-transform group-hover/btn:scale-110" />
                  <span class="text-[10px] font-bold uppercase tracking-wider"
                    >Enviar Email</span
                  >
                </a>
